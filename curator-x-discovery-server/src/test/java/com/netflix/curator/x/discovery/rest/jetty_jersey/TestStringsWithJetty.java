...
import com.netflix.curator.x.discovery.rest.concretes.StringDiscoveryResource;
...
public class TestStringsWithJetty
{
    ...
    public void         setup() throws Exception
    {
        ...
        context = new StringDiscoveryContext(new MockServiceDiscovery<String>(), config);
