...
public interface TypedModeledFramework6<M, P1, P2, P3, P4, P5, P6> {
     ...
     */
    static <M, P1, P2, P3, P4, P5, P6> TypedModeledFramework6<M, P1, P2, P3, P4, P5, P6> from(
            ModeledFrameworkBuilder<M> frameworkBuilder, TypedModelSpec6<M, P1, P2, P3, P4, P5, P6> modelSpec) {
        return (client, p1, p2, p3, p4, p5, p6) -> frameworkBuilder
                .withClient(client)
                .withModelSpec(modelSpec.resolved(p1, p2, p3, p4, p5, p6))
                .build();
    }
    ...
    static <M, P1, P2, P3, P4, P5, P6> TypedModeledFramework6<M, P1, P2, P3, P4, P5, P6> from(
        ...
        return (client, p1, p2, p3, p4, p5, p6) -> frameworkBuilder
                .withClient(client)
                .withModelSpec(typedModelSpec.resolved(p1, p2, p3, p4, p5, p6))
                .build();
    }
}
