...
public interface TypedModeledFramework5<M, P1, P2, P3, P4, P5> {
     ...
     */
    static <M, P1, P2, P3, P4, P5> TypedModeledFramework5<M, P1, P2, P3, P4, P5> from(
            ModeledFrameworkBuilder<M> frameworkBuilder, TypedModelSpec5<M, P1, P2, P3, P4, P5> modelSpec) {
        return (client, p1, p2, p3, p4, p5) -> frameworkBuilder
                .withClient(client)
                .withModelSpec(modelSpec.resolved(p1, p2, p3, p4, p5))
                .build();
    }
    ...
    static <M, P1, P2, P3, P4, P5> TypedModeledFramework5<M, P1, P2, P3, P4, P5> from(
        ...
        return (client, p1, p2, p3, p4, p5) -> frameworkBuilder
                .withClient(client)
                .withModelSpec(typedModelSpec.resolved(p1, p2, p3, p4, p5))
                .build();
    }
}
