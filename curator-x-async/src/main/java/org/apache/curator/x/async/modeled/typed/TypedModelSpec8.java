...
public interface TypedModelSpec8<M, P1, P2, P3, P4, P5, P6, P7, P8> {
     ...
     */
    static <M, P1, P2, P3, P4, P5, P6, P7, P8> TypedModelSpec8<M, P1, P2, P3, P4, P5, P6, P7, P8> from(
            ModelSpecBuilder<M> builder, TypedZPath8<P1, P2, P3, P4, P5, P6, P7, P8> path) {
        return (p1, p2, p3, p4, p5, p6, p7, p8) ->
                builder.withPath(path.resolved(p1, p2, p3, p4, p5, p6, p7, p8)).build();
    }
    ...
    static <M, P1, P2, P3, P4, P5, P6, P7, P8> TypedModelSpec8<M, P1, P2, P3, P4, P5, P6, P7, P8> from(
        ...
        return (p1, p2, p3, p4, p5, p6, p7, p8) ->
                builder.withPath(zPath.resolved(p1, p2, p3, p4, p5, p6, p7, p8)).build();
    }
}
